<%-- 
    Document   : marcas
    Created on : 10/10/2020, 11:17:13 AM
    Author     : USUARIO
--%>
      ...
      <body>
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Tabla Productos</a>
        ...
        <div class="modal fade" id="modal_ME">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="sr_marcas_p" method="post" class="form-group" >
                ...
                <input type="number" name="txt_id_marca" id="txt_id_marca" class="form-control" value="0" readonly>
        ...
        <script>
            ...
            $('#tbl_marcas').on('click','tr td', function(evt){
               ...
               target = $(event.target);
               id_marca = target.parents("tr").find("td").eq(0).html();
